...
Route::get('/realtimeAnalytic', [DataLivetestController::class, 'index'])->name('realtimeAnalytic')->middleware('auth');
Route::delete('/realtimeAnalytic', [DataLivetestController::class, 'destroy'])->name('data_livetest.destroy')->middleware('auth');
...
Route::get('/documents', [DownloadController::class, 'index'])->middleware('auth');
Route::post('/documents', [DownloadController::class, 'create']);
Route::post('/documents/download', [DownloadController::class, 'download'])->middleware('auth')->name('documents.download');
Route::post('/documents/download2', [DownloadController::class, 'download2'])->middleware('auth')->name('documents.download2');
